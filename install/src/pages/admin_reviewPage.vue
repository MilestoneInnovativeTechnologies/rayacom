  ...
  <div class="q-pa-md row items-start q-gutter-md" v-if="totalcount">
      ...
      <q-list>
        <q-item class="bg-brand text-white text-bold">
          <q-item-section>
            <q-item-label class="text-overline">{{ i.customer.name }}</q-item-label>
            <q-item-label>{{ i.created_at }}</q-item-label>
            <q-item-label>
        ...
        <q-card class="my-card" style="max-width: 400px">
          <q-list bordered class="rounded-borders">
            ...
            <q-item>
              ...
              <q-item-section top>
                <q-item-label class="flex-center text-left">{{ specificComment }}</q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section avatar>
...
export default {
  setup () {
    ...
    const updateStatus = function (){
      post('review','status',{ id :specificId.value, status: specificStatus.value })
        .then(console.log)
    }
